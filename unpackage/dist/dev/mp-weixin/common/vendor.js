...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.baseUrl = void 0;var baseUrl = "http://people.phper.wiki";exports.baseUrl = baseUrl;
...
"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.req = req;exports.verifyToken = verifyToken;exports.refreshToken = refreshToken;exports.getAuthentication = getAuthentication;var _regenerator = _interopRequireDefault(__webpack_require__(/*! ./node_modules/@babel/runtime/regenerator */ 8));var _config = __webpack_require__(/*! ./config.js */ 11);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) {try {var info = gen[key](arg);var value = info.value;} catch (error) {reject(error);return;}if (info.done) {resolve(value);} else {Promise.resolve(value).then(_next, _throw);}}function _asyncToGenerator(fn) {return function () {var self = this,args = arguments;return new Promise(function (resolve, reject) {var gen = fn.apply(self, args);function _next(value) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value);}function _throw(err) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err);}_next(undefined);});};}function ownKeys(object, enumerableOnly) {var keys = Object.keys(object);if (Object.getOwnPropertySymbols) {var symbols = Object.getOwnPropertySymbols(object);if (enumerableOnly) symbols = symbols.filter(function (sym) {return Object.getOwnPropertyDescriptor(object, sym).enumerable;});keys.push.apply(keys, symbols);}return keys;}function _objectSpread(target) {for (var i = 1; i < arguments.length; i++) {var source = arguments[i] != null ? arguments[i] : {};if (i % 2) {ownKeys(Object(source), true).forEach(function (key) {_defineProperty(target, key, source[key]);});} else if (Object.getOwnPropertyDescriptors) {Object.defineProperties(target, Object.getOwnPropertyDescriptors(source));} else {ownKeys(Object(source)).forEach(function (key) {Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key));});}}return target;}function _defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;}
...
/**
   * 验证token是否过期
   */function
verifyToken() {return _verifyToken.apply(this, arguments);}
...
/**
                                                             * 刷新token
                                                             */function _verifyToken() {_verifyToken = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee() {return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:return _context.abrupt("return", new Promise(function (resolve, reject) {var token = uni.getStorageSync('token');if (!token) {resolve(false);}uni.request({ url: _config.baseUrl + '/api/token/check', method: 'GET', data: { token: token }, success: function success(res) {if (res.data.code === 1) {refreshToken();} else {resolve(false);}resolve(res);} });}));case 1:case "end":return _context.stop();}}}, _callee);}));return _verifyToken.apply(this, arguments);}function
...
/**
                                                               * 获取鉴权url
                                                               */function _refreshToken() {_refreshToken = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee2() {var token;return _regenerator.default.wrap(function _callee2$(_context2) {while (1) {switch (_context2.prev = _context2.next) {case 0:token = uni.getStorageSync('token');uni.request({ url: _config.baseUrl + '/api/token/refresh', method: 'GET', data: { token: token }, success: function success(res) {if (res.data.code === 1) {uni.setStorageSync("token", res.data.data.token);}} });case 2:case "end":return _context2.stop();}}}, _callee2);}));return _refreshToken.apply(this, arguments);}
function getAuthentication() {
  return new Promise(function (resolve, reject) {
    uni.request({
      url: _config.baseUrl + '/api/index/index',
      method: 'GET',
      success: function success(res) {
        resolve(res);
      } });
